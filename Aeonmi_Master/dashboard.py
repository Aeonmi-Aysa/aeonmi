...
3. write_file/append_file: pipe | separates path from content.
4. For files >300 lines: write first half with write_file, second with append_file.
...
def _call_openrouter(key, system, messages, _msg):
    import urllib.request
    payload = json.dumps({
        "model": os.environ.get("AEONMI_OPENROUTER_MODEL", "anthropic/claude-3-haiku"),
