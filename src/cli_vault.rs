...
pub enum VaultCommand {
    /// Initialize the Glyph Identity System (MGK + boot ceremony)
    Init(VaultInitArgs),
...
pub struct VaultInitArgs {
    /// Passphrase to seal the Master Glyph Key (prompted interactively if omitted)
    #[arg(long, value_name = "PASSPHRASE")]
    pub passphrase: Option<String>,
    /// Force re-initialization even if an MGK already exists
