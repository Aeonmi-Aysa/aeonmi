...
Generated for project: QasmTest
...
def main():
    ...
    # Load QASM file
    qasm_file = Path(r"C:/Users/wlwil/Downloads/Aeonmi-SPACEJEDI/Aeonmi-SPACEJEDI/QasmTest/output/circuit.qasm")
