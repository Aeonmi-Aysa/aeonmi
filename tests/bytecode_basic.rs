...
use aeonmi_project::core::vm_bytecode::VM;

fn eval_bytecode(src: &str) -> Option<aeonmi_project::core::vm_bytecode::Value> {
...
#[test]
fn arithmetic() {
    let v = eval_bytecode("let a=1; let b=2; return a+b*3;");
    match v {
        Some(aeonmi_project::core::vm_bytecode::Value::Number(n)) => assert_eq!(n, 7.0),
